...
public class App 
{
	...
	*/
    public static void main( String[] args )
    {
		...
		System.out.println("Their OR operation is: " + orResult.getValue());
		Binary andResult = Binary.and(binary1, binary2);
		System.out.println("Their AND operation is: " + andResult.getValue());
		Binary multiplyResult = Binary.multiply(binary1, binary2);
		System.out.println("Their Binary Product is: " + multiplyResult.getValue());
    }
}